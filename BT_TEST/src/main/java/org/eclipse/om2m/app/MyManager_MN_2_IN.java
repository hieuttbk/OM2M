...
public class MyManager_MN_2_IN {
	...
	private static String aeName = "mymanager_2";
	private static String aeProtocol="http";
	private static String aeIp = "127.0.0.1";
	private static int aePort = 1600;				// My manager port
	private static String subName="managersub_MN_2";
