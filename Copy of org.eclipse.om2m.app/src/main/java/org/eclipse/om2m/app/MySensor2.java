...
public class MySensor2 {
	...
	private static int csePort = 8383;				// ? port nay cua MN
	private static String cseId = "mn-cse-2";
	private static String cseName = "mn-name-2";
 
	private static String aeName = "TEST_MN";
