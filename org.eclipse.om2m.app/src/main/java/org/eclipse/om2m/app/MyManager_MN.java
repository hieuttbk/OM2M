...
public class MyManager_MN {
	...
	private static int aePort = 1501;				// My manager port
	private static String subName="managersub_MN";
	private static String targetSensorContainer="mn-cse-c/mn-name-c/TEST4/data";
